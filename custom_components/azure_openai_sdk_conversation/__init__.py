...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:  
    ...
    try:  
        ...
        raise ConfigEntryNotReady(f"Failed to connect to Azure OpenAI at {api_base}: {err}") from err  
    ...
    if resp.status_code >= 400:  
        ...
        raise ConfigEntryNotReady(f"Azure OpenAI /models returned {resp.status_code}: {body}")  
