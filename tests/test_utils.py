...
def test_build_profile_filename():
    ...
    assert (
        build_profile_filename("thermostat", "kitchen") == "cronostar_kitchen_data.json"
    )
    assert build_profile_filename("thermostat", "") == "cronostar_default_data.json"
    assert (
        build_profile_filename("thermostat", "cronostar_thermostat_kitchen_")
        == "cronostar_thermostat_kitchen_data.json"
    )
