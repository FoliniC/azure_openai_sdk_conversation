...
async def test_async_setup_entry_success(hass):
    ...
    with patch("custom_components.azure_openai_sdk_conversation.conversation.AzureOpenAIConversationAgent") as mock_agent_class, \
         patch("homeassistant.components.conversation.async_set_agent") as mock_set_agent:
